<template>
    <div>
            ...
            <form @submit.prevent="handleFileChange">
                ...
                <section class="flex items-center mt-4 space-x-4">
                    ...
                    <button
                        type="reset"
                        @click="reset"
                        class="text-gray-600 btn-outline"
                    >
                        Reset
                    </button>
                </section>
        ...
        <BoxShadow class="p-4 mt-4">
            <div v-if="imageField == 'thumbnail'" class="text-gray-800">
                Current Thumbnail
            </div>
            ...
            <section class="flex items-center mt-4 space-x-4">
                ...
                <div v-else class="relative flex flex-row justify-between">
                    ...
                    <div
                        v-if="product.second_image"
                        class="relative flex-1 ml-4"
                    >
                        <img
                    ...
                    <div
                        v-if="product.third_image"
                        class="relative flex-1 ml-4"
                    >
                        <img
                            :src="getImageUrl(product.third_image)"
                            alt="Product Image"
                            class="object-cover w-full h-40 rounded-md"
                        />
                        <button
